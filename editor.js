...
// Customization for product-grid
    ...
    customizationPanel.innerHTML = `
        <div class="customization-card">
            <h4>Product Grid Customization</h4>
            <div class="two-column-grid">
                <!-- Row 1 -->
                <div>
                    <label for="grid-columns"><i class="fas fa-th"></i> Number of Columns:</label>
                    <input type="number" id="grid-columns" value="2" min="1" max="4">
                </div>
                <div>
                    <label for="grid-gap"><i class="fas fa-arrows-alt-h"></i> Grid Gap:</label>
                    <input type="number" id="grid-gap" value="10" min="0">
                </div>
                <!-- Row 2 -->
                <div>
                    <label for="grid-bg-color"><i class="fas fa-palette"></i> Background Color:</label>
        ...
        <div class="customization-card">
            <h4>Actions</h4>
            <button id="remove-product-grid"><i class="fas fa-trash"></i> Remove Product Grid</button>
        </div>
    `;
...
function createElement(type) {
    ...
    switch (type) {
        ...
        case 'product-grid':
            ...
            heading.textContent = 'Product Grid';
